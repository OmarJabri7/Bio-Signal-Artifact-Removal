...
private:
    ...
    double inner_gain[3] = {
        ...
        15.8105,
        18.9};
    double remover_gain[3] = {10, 8.4, 8.4};
    double feedback_gain[3] = {1, 1, 0.1};
    double wEta[3] = {1, 1.66316, 1.58};
    double wEtaPower[3] = {0, 0.5, 0.5};
    double bEta[3] = {2, 0.621053, 1.2};
    double bEtaPower[3] = {0, -0.5, -0.5};
