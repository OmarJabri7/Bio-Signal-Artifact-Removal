...
void Neuron::updateWeights()
{
    ...
    overallError = (globalCoeff * globalError + backwardsCoeff * backwardError + midCoeff * forwardError + forwardCoeff * midError + localCoeff * localError + echoCoeff * echoError);
